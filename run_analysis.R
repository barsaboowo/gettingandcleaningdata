...
run_analysis <- function(){
  library(dplyr)
  #Read in the columns
  col_names <- read.csv("./uci_har_dataset/features.txt", header=FALSE, sep="", col.names=c("Pos", "Name")) 
  col_names <- as.character(col_names[,"Name"])
  
  #Read in the subjects
  subjects_test = read.csv("./uci_har_dataset/test/subject_test.txt", header=FALSE)  
  subjects_train = read.csv("./uci_har_dataset/train/subject_train.txt", header=FALSE)
  
  #Read in the activity labels
  activity_labels <- read.csv("./uci_har_dataset/activity_labels.txt", header=FALSE, sep="", col.names=c("No", "Name"))
  activities_train <- read.csv("./uci_har_dataset/train/y_train.txt", header=FALSE)
  activities_test  <- read.csv("./uci_har_dataset/test/y_test.txt", header=FALSE)
  ...
  #Read in the data
  data_train <- read.csv("./uci_har_dataset/train/X_train.txt", sep="", header=FALSE, col.names=col_names)
  data_test <- read.csv("./uci_har_dataset/test/X_test.txt", sep="", header=FALSE, col.names=col_names)
